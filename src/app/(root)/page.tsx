...
import { getAnimeQuote, getSeasonAnimes, getTopAnimes } from "@/lib/animeAPI";
...
const HomePage = async () => {
  ...
  return (
    <div className="container mx-auto lg:px-4">
      ...
      <section id="current-season-animes" className="py-2.5 lg:pt-10">
        ...
        <Carousel opts={{ loop: true }} className="hidden lg:block">
          <CarouselContent>
            {groupedSeasonAnimes.map((group, index) => (
              <CarouselItem
                key={index}
                className="flex *:flex-1 gap-3 items-center h-[20vw] 2xl:h-[300px]"
              >
      ...
      <section id="top-animes" className="py-2.5">
        <div className="flex items-center justify-between">
